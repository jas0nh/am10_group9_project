...
df1 <- read_csv(file = 'data viz dataset/Health_Nutrition_and_Population.csv', na = "..", show_col_types = FALSE) 
...
lm1 <-lm(life_expectancy ~ infant_deaths
 + bmi + polio + percentage_expenditure + hepatitis_b +measles 
+ under_five_deaths +total_expenditure + diphtheria + hiv_aids + gdp + income_composition_of_resources + schooling+ alcohol,lc_2014)
...
lm2 <- lm(life_expectancy ~ infant_deaths
 + bmi + polio + percentage_expenditure + hepatitis_b +measles 
+ under_five_deaths +total_expenditure + diphtheria + hiv_aids + gdp + income_composition_of_resources + schooling+ alcohol,lc_2004)
...
lm_new2=lm(life_expectancy ~ hiv_aids + schooling + under_five_deaths,lc_2004)
...
lm3 <- lm(life_expectancy ~ infant_deaths
 + bmi + polio + percentage_expenditure + hepatitis_b +measles 
+ under_five_deaths + total_expenditure + diphtheria + hiv_aids + gdp + income_composition_of_resources + schooling+ alcohol,lc_2000)

summary(lm3)

lm_new3=lm(life_expectancy ~ adult_mortality + hiv_aids +schooling + hepatitis_b
,lc_2000)
